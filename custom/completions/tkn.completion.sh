...
_tkn_clustertask_start()
{
    ...
    flags+=("--skip-optional-workspace")
    local_nonpersistent_flags+=("--skip-optional-workspace")
    flags+=("--timeout=")
...
_tkn_pipeline_export()
{
    last_command="tkn_pipeline_export"
...
_tkn_pipelinerun_cancel()
{
    ...
    flags+=("--grace=")
    two_word_flags+=("--grace")
    local_nonpersistent_flags+=("--grace")
    local_nonpersistent_flags+=("--grace=")
    flags+=("--context=")
    two_word_flags+=("--context")
    two_word_flags+=("-c")
